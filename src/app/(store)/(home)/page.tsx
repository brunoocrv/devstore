...
async function getFeaturedProducts(): Promise<ProductInterface[]> {
...
export default async function StoreHome() {
  const [featuredProduct, ...otherProducts] = await getFeaturedProducts()
    ...
    <div className="grid max-h-[800px] grid-cols-9 grid-rows-6 gap-6">
      ...
      >
        ...
        <div className="absolute bottom-28 right-28 h-12 flex items-center gap-2 max-w-[280px] rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5">
          <span className="text-sm truncate">{featuredProduct.title}</span>
